...
final _blocksFile = chainPath('kusama/v16/blocks.jsonl');
final _runtimeUpgradesFile = chainPath('kusama/v16/runtime_upgrades_v16.json');
final _metadataDir = chainPath('kusama/v16');
...
void main() {
  group('Kusama V16 Extrinsics - Input Validation', () {
  ...
  group('Kusama V16 Extrinsics - Decode', () {
    for (final block in _blocks) {
      final blockNumber = block['blockNumber'] as int;
      final extrinsics = block['extrinsics'] as List<dynamic>;
      ...
      test('block $blockNumber', () {
        ...
        final metadataInfo = getOrLoadMetadata(specVersion, _metadataDir, 'kusama_v16');
  ...
  group('Kusama V16 Extrinsics - Round-trip', () {
