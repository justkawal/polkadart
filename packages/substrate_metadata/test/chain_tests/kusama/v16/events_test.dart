...
final _eventsFile = chainPath('kusama/v16/events.jsonl');
...
void main() {
  group('Kusama V16 Events - Input Validation', () {
  ...
  group('Kusama V16 Events - Decode', () {
    for (final eventRecord in _events) {
      final blockNumber = eventRecord['blockNumber'] as int;
      final eventsHex = eventRecord['events'] as String;
  ...
  group('Kusama V16 Events - Round-trip', () {
