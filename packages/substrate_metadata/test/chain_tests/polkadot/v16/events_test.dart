...
final _eventsFile = chainPath('polkadot/v16/events.jsonl');
...
void main() {
  group('Polkadot V16 Events - Input Validation', () {
  ...
  group('Polkadot V16 Events - Decode', () {
    for (final eventRecord in _events) {
      final blockNumber = eventRecord['blockNumber'] as int;
      final eventsHex = eventRecord['events'] as String;
  ...
  group('Polkadot V16 Events - Round-trip', () {
