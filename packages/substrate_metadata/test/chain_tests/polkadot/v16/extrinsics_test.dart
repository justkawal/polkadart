...
final _blocksFile = chainPath('polkadot/v16/blocks.jsonl');
final _runtimeUpgradesFile = chainPath('polkadot/v16/runtime_upgrades_v16.json');
final _metadataDir = chainPath('polkadot/v16');
...
void main() {
  group('Polkadot V16 Extrinsics - Input Validation', () {
  ...
  group('Polkadot V16 Extrinsics - Decode', () {
    for (final block in _blocks) {
      final blockNumber = block['blockNumber'] as int;
      final extrinsics = block['extrinsics'] as List<dynamic>;
      ...
      test('block $blockNumber', () {
        ...
        final metadataInfo = getOrLoadMetadata(specVersion, _metadataDir, 'polkadot_v16');
  ...
  group('Polkadot V16 Extrinsics - Round-trip', () {
